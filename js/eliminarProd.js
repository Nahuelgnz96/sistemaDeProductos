    ...
    if (selectedProducts.length > 0) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const queryString = 'productosAEliminar=' + selectedProducts.join(',');
                ...
                xhr.onload = function () {
                    if (xhr.status >= 200 && xhr.status < 300) {
                        if (xhr.responseText === "success") {
                            ...
                            Swal.fire('Error', 'Error al eliminar productos: ' + xhr.responseText, 'error');
                        }
                    } else {
                ...
                xhr.open('POST', 'controllers/c_eliminar_prod.php', true);
        ...
        Swal.fire({
            title: 'No se han seleccionado productos para eliminar.',
        })
    }
});
